...
BINDINGS = {"atomic_quinte_product", "not_applicable"}
...
ROUTES = {"direct-evidence", "QUINTE", "human-review", "block"}
    ...
    if not isinstance(execution, dict):
        ...
        if outcome is not None:
            if not isinstance(outcome, dict):
                ...
                elif outcome.get("decision") != "PASS":
